...
export class Factory__getFactoryStateResult {
  ...
  constructor(value0: Array<Address>, value1: Address, value2: Address) {
    this.value0 = value0;
    this.value1 = value1;
    this.value2 = value2;
  }
...
export class Factory extends ethereum.SmartContract {
  ...
  try_baseTokenPriceFeed(): ethereum.CallResult<Address> {
  ...
  getFactoryState(): Factory__getFactoryStateResult {
    let result = super.call(
      "getFactoryState",
      "getFactoryState():(address[],address,address)",
      []
    );
  ...
  getVaultState(_vault: Address): Factory__getVaultStateResult {
    let result = super.call(
      "getVaultState",
      "getVaultState(address):((address,address,uint8,uint256)[],(address,uint256,address),(uint256,uint256),(bool,uint8,string,string),(address,uint256,uint256,uint256,uint256,uint256),(uint256,uint256,uint256,uint256,uint256,uint256,uint256),uint256[],uint256[],uint256,uint256)",
      [ethereum.Value.fromAddress(_vault)]
    );
